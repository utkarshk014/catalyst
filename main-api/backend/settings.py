...
SECRET_KEY = 'django-insecure-*5u2j9ofwgh1ia#%ybnyx8p(lpejk$x^@lb1rke6xcsuh03$-a'
...
INSTALLED_APPS = [
    ...
    'graphene_django', # Add Graphene
    'projects', # Add our new projects app
    'corsheaders',
]
...
MIDDLEWARE = [
    ...
    'projects.middleware.OrganizationAuthMiddleware'
]
...
CORS_ALLOW_HEADERS = [
    ...
    'x-csrftoken',
    'x-requested-with',
    'x-api-key',  # Add this for our custom API key header
]
